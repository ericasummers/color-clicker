...
// var ctx;
//
// function colorBox(color,x , y, blocktype, pointValue, screenTime) {//add sound/animation later
//   this.width=150;
//   this.height=150;
//   this.color = color;
...
//     var xpos = Math.ceil(Math.random()*$("#canvas").width()-150);
//     var ypos = Math.ceil(Math.random()*$("#canvas").height()-150);
//
//
